...
const testFolderPath = path_1.default.join(__dirname, 'testFolder');
describe('Creating RepoHandler instance', function () {
    ...
    it('Success instance creating with correct path', function () {
        ...
        chai_1.default.expect(repoHandler.directoryPath).to.eql(testFolderPath);
    });
    it('Error instance creating with path to not existing folder', function () {
        // Generating random folder name
        let randomID;
        do {
            randomID = v4_1.default();
        } while (fs_1.default.existsSync(path_1.default.join(__dirname, 'testFolder', randomID)));
        chai_1.default
            .expect(() => new RepoHandler_1.default(path_1.default.join(testFolderPath, randomID)))
            .to.throw('Please provide correct path to repos folder!');
    });
    it('Error instance creating with path to file, not folder', function () {
        chai_1.default
            .expect(() => new RepoHandler_1.default(path_1.default.join(testFolderPath, 'file.txt')))
            .to.throw('Please provide correct path to repos folder!');
    });
});
describe('API Methods', function () {
    ...
    describe('Get commits', function () {
        ...
        it('GET /api/repos/:repositoryId/commits/:commitHash with hash', function (done) {
            // branch2 hash
            supertest_1.default(server.serverInstance)
                .get('/api/repos/repo1/commits/2084e5881ce10caafb9125185bf79d67a37e49a8')
                .expect('Content-Type', /json/)
                .expect(200, {
                data: [
                    {
    ...
    describe('Get commit diff', function () {
        it('GET /api/repos/:repositoryId/commits/:commitHash/diff with master branch name', function (done) {
            supertest_1.default(server.serverInstance)
                ...
                .expect('Content-Type', /json/)
                .expect(200, {
                data: 'commit 1b53498b1b46690f5c8e70e6a44a74369abf8fb1\n' +
        ...
        it('GET /api/repos/:repositoryId/commits/:commitHash/diff with hash', function (done) {
            // branch2 hash
            supertest_1.default(server.serverInstance)
                .get('/api/repos/repo1/commits/2084e5881ce10caafb9125185bf79d67a37e49a8/diff')
                .expect('Content-Type', /json/)
                .expect(200, {
                data: 'commit 2084e5881ce10caafb9125185bf79d67a37e49a8\n' +
                    'Author: Vladislav Yeremeyev <vlad.yeremeyev@gmail.com>\n' +
    ...
    describe('Get blob content', function () {
        ...
        it('GET /api/repos/:repositoryId/blob/hash/*file*', function (done) {
            supertest_1.default(server.serverInstance)
                .get('/api-test/repos/repo1/blob/18f7539e338123da6be4e21fe15be35287a2d7a0/file1.txt')
                .expect(200, {
        ...
        it('GET /api/repos/:repositoryId/blob/hash/*pathToFile*', function (done) {
            supertest_1.default(server.serverInstance)
                .get('/api-test/repos/repo1/blob/18f7539e338123da6be4e21fe15be35287a2d7a0/folder1/file_in_folder.txt')
                .expect(200, {
                data: 'folder file\n'
            }, done);
        });
