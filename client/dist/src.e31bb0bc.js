...
document.addEventListener('DOMContentLoaded', function () {
  var dropdowns = document.querySelectorAll('.DropdownBlock');
  dropdowns.forEach(function (block) {
    return block.addEventListener('click', function (e) {
      ...
      Array.from(dropdowns).filter(function (elem) {
        return elem !== block;
  ...
  var tabs = document.querySelectorAll('.TabMenu-Tab');
  tabs.forEach(function (tab) {
    return tab.addEventListener('click', function () {
      var siblings = _toConsumableArray(tab.parentElement.children).filter(function (c) {
        return c != tab;
      });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36967" + '/');
